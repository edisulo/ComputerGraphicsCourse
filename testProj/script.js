...
class Page {
  constructor(number, pdfDoc, frontPageNum, backPageNum, totalPages) {
    ...
    Promise.all([
      ...
      this.coverRoughness = loader.load("pics/page1-back.jpg");
...
const defaultPdfUrl = "mypdf/projectmanagement.pdf";
...
const background = new THREE.TextureLoader().load("pics/space2.jpg");
